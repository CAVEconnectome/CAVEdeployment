...
export AUTH_VERSION=2.7.2
export NGLSTATE_VERSION=refactor-39
export INFOSERVICE_VERSION=3.8.1
export EMANNOTATIONSCHEMAS_VERSION=3.5.3


# REPLICAS

export AUTH_REPLICAS=4
