...
export DOMAIN_NAME={{ domain_names[0] }}
...
export KEY_FOLDER=${INFRASTRUCTURE_FOLDER}/../../gcloud_keys/$ENVIRONMENT
export YAML_FOLDER=${INFRASTRUCTURE_FOLDER}/../../kubeyamls/${ENVIRONMENT}
